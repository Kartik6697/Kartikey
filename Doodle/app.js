...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // class for platform
  class Platform {
    // constructor for construct our class
...
function fall() {
  ...
  function jump() {
    ...
    isJumping = true
    upTimerId = setInterval(function ()  {  //uptimerid pass through the function for every 30ms
      ...
      if (doodlerBottomSpace > (startPoint + 200)) {  // this contion is for doodler to jump to certain height after land to the platform
        fall()
        isJumping = false
      }
    },30)
